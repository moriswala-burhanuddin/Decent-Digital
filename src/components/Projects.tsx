import { Star, ArrowRight, Sparkles, Github } from 'lucide-react';
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-20 relative overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-blue-400/10 dark:bg-blue-500/10 rounded-full blur-[40px] will-change-transform" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-400/10 dark:bg-purple-500/10 rounded-full blur-[40px] will-change-transform" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-slate-800/60 backdrop-blur-md rounded-full border border-blue-200/50 dark:border-blue-500/30 mb-6 shadow-lg shadow-blue-500/10">
